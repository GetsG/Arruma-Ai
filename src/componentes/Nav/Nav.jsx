    ...
    return(
        <footer className={estilos.nav}>
            <nav>
                ...
                <Link href="notificacoes"> <Image className={estilos.icone} src={Sino} alt="Ícone de sino, botão para notificações"/> </Link>
                <Link href="/perfil"> <Image className={estilos.icone} src={Perfil} alt="Ícone de perfil, botão para acessar conta do usuário"/> </Link>
            </nav>
        </footer>
    );
}